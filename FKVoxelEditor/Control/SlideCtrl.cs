...
{
    public class SlideCtrl : UserControl
    {
        #region ======== 成员变量 ========
        ...
        private bool            m_bValueChanging;

        private Rectangle       m_rcLeftArrow;
        private Rectangle       m_rcRightArrow;
        ...
        public float GetPos() { return m_fPos; }
